    ...
    index: function () {
        $(document).ready(function () {
            ...
            $('div#catalog-tree').jstree({
                ...
                "json_data": {
                    "ajax": {
                        ...
                        "url": baseurl + '/backend/catalog/get-child',
                        "type": "post",
                        "data": function (n) {
            ...
            $(document).on('click', '.edit', function () {
                ...
                if (catalogID) {
                    editURL = baseurl + '/backend/catalog/edit/id/' + catalogID;
    ...
    add: function () {
        $(document).ready(function () {
            ...
            $("#catalogImage").Nileupload({
                action: baseurl + '/backend/catalog/upload',
                size: '2MB',
            ...
            if (catalogID) {
                bootbox.confirm('Bạn có muốn xóa danh mục này không', function (res) {
                    if (res) {
                        $.ajax({
                            type: "POST",
                            url: baseurl + '/backend/catalog/delete',
                            cache: false,
                            dataType: 'json',
                            data: {
                                'catalogID': catalogID
